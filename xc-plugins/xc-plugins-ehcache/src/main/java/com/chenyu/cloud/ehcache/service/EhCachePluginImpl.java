 ...
 * the License.
 */
package com.chenyu.cloud.ehcache.service;

import cn.hutool.core.util.StrUtil;
import com.alibaba.fastjson.JSONObject;
import com.chenyu.cloud.common.constants.EhcacheConstants;
import com.chenyu.cloud.ehcache.EhCachePlugin;
import com.chenyu.cloud.ehcache.message.EhCacheMsg;
...
public class EhCachePluginImpl implements EhCachePlugin {
    ...
    /** Ehcache Json Key */
    private static final String EHCACHE_JSON_KEY = EhcacheConstants.EHCACHE_JSON_KEY;
