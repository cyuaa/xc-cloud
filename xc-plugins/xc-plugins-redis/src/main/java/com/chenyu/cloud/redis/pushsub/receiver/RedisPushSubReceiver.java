...
public class RedisPushSubReceiver extends BaseReceiver {
    ...
    /** 监听信道 */
    public static final String CHANNEL = CoreConstants.PLATFORM_NAME;
