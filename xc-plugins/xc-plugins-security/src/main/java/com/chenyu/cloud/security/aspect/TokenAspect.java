 ...
 * the License.
 */
package com.chenyu.cloud.security.aspect;
...
import static com.chenyu.cloud.common.constants.OrderConstants.TOKEN_AOP_SORT;
...
public class TokenAspect {
    ...
    @Pointcut("execution(public * com.chenyu..*.*Controller*.*(..)) || execution(public * com.chenyu..*.*Rest*.*(..))")
