 ...
 * the License.
 */
package com.chenyu.cloud.utils;
...
import com.chenyu.cloud.properties.CacheProperties;
...
public class CacheUtil {
    ...
    public void init(CacheProperties cacheProperties){
        if(cacheProperties != null){
            // 获得 超级管理员
            CacheUtil.PREFIX_NAME = Convert.toStr(cacheProperties.getPrefix(), CoreConstants.PLATFORM_NAME) + ":";
        }
    }
